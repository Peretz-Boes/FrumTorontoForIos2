//
//  ContactUsWebpageViewController.swift
//  FrumToronto
//
...
class ContactUsWebpageViewController: UIViewController {

    @IBOutlet weak var contactUsWebView: UIWebView!
    override func viewDidLoad() {
        super.viewDidLoad()
        if InternetConnectivity.isInternetServiceAvailable() {
            let url = URL(string: "http://www.frumtoronto.com/ContactUS.asp")!
    ...
    override func motionEnded(_ motion: UIEventSubtype, with event: UIEvent?) {
        performSegue(withIdentifier: "contactUsViewControllerSegueFive", sender: nil)
    }
